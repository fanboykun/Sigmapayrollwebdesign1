// Export all clinic components from a single entry point
...
export { QueueSlip } from './QueueSlip'

// Existing Clinic Components (if any)
// Add other clinic components here as they are created
